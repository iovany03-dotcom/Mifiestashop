...
<script defer src="/assets/cms-cart.js"></script><script defer src="/assets/cms.js"></script><script defer src="/assets/cms-gallery.js"></script><script defer src="/assets/cms-title-override.js"></script><script defer src="/assets/cms-reviews.js"></script>${t.promoPackages ? '<script defer src="/assets/cms-promo-pricing.js"></script>' : ''}${p.vip ? '<script defer src="/assets/cms-vip.js"></script>' : ''}</head>
...
${p.theme === 'xv' ? `<section class="xv-photos wrap" aria-label="Fotos de fiestas de XV años con accesorios de Mi Fiesta Shop"><figure><img src="/img/cms/xv-anos/glow-accesorios.webp" alt="Invitados con pulseras, collares y bastones luminosos de Mi Fiesta Shop en una fiesta de XV años" loading="lazy" width="941" height="1672"><figcaption>Pulseras, collares y bastones luminosos</figcaption></figure><figure><img src="/img/cms/xv-anos/lentes-led-grupo.webp" alt="Grupo de invitados con lentes LED de Mi Fiesta Shop en una fiesta de XV años" loading="lazy" width="940" height="1672"><figcaption>Lentes LED para toda la mesa</figcaption></figure></section>` : ''}
